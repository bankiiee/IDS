...
<div style="width: 200%; margin-top: 0px;" >
    <h1>Manage News Outbox</h1>

    <sql:query var="result" dataSource="db">
        SELECT id,publisher,topic,story,fromdate,todate,forusergroupid,newstypeid,mediaid,attchpath,status,priorityid,remark from news where status = 'active' order by id desc;
    </sql:query>
