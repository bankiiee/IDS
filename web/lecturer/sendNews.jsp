...
<div class="form_wrapper" id="form_wrapper" style="font-size: 16px;">
        ...
        <fieldset>
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="fromdate" value="2012-01-01" size="50%" placeholder="yyyy-mm-dd" id="datepicker" /></td>
