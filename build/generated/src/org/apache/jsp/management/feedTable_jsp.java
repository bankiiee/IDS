...
String ct = this.getServletContext().getContextPath();
      ...
      out.write("       \n");
      out.write("        \n");
      out.write("        $('#sortable').masonry({\n");
      out.write("            // options\n");
      out.write("            itemSelector : '.newsDetail',\n");
      out.write("            columnWidth : 20,\n");
      out.write("            isAnimated: !Modernizr.csstransitions,\n");
      out.write("            animationOptions: {\n");
      out.write("                duration: 400\n");
      out.write("            }\n");
      out.write("        });\n");
      out.write("        $( \"#sortable\" ).sortable({\n");
      out.write("            appendTo: '#topic' \n");
      out.write("        });\n");
      ...
      out.write("    });\n");
      out.write("        \n");
      out.write("    function showArticle(newsid, topic, story){\n");
      out.write("        var cssObj = {\n");
      out.write("            'height':'600','width':'600'\n");
      out.write("        }\n");
      out.write("\n");
      out.write("        $(\"#\"+newsid).clone().css(cssObj).dialog({show : 'slide',modal:true,width:600,height:600,buttons: {\n");
      out.write("                \"Share to Facebook\": function() {\n");
      out.write("//                    var status = window.showModalDialog(\"http://www.facebook.com/sharer.php?u=\"+window.location.href+\"&amp;t=\"+topic+\"<br>\"+story, 'popup');\n");
      out.write("                //  alert(topic);\n");
      out.write("                   window.location.href = '../sharefb.jsp?topic='+topic+\"&story=\"+story;\n");
      out.write("                   $( this ).dialog( \"close\" );\n");
      out.write("                },\n");
      out.write("                \"Share to Twitter\": function() {\n");
      out.write("                    window.open(\"http://twitter.com/home?status=via 'IDS' - \"+topic+\"%20%20\"+window.location.href);\n");
      out.write("       \n");
      out.write("\n");
      out.write("                    $( this ).dialog( \"close\" );\n");
      out.write("                }\n");
      out.write("            }});\n");
      out.write("    }\n");
      out.write("    function showAttch(path){\n");
      out.write("    var attch = document.getElementById(\"showAttch\").innerHTML = \"<center><a href ='\"+path+\"'>Download Full-sized Picture</a><br><img src='\"+path+\"' style='width:70%;height:auto;'  /></center>\";\n");
      out.write("    $(\"#showAttch\").dialog({show:'slide',width:600,height:600});\n");
      out.write("    }\n");
      out.write("    \n");
      out.write("</script>\n");
      ...
      out.write("\n");
      out.write("\n");
      out.write("<div class=\"newsthumb\" style=\"width: 1000px\">\n");
      out.write("    <ul id=\"draggable\" class=\"\"> <h1>News</h1></ul>\n");
      out.write("    <ul id=\"sortable\" style=\"\">\n");
      out.write("\n");
      out.write("        ");
      //  c:forEach
      ...
      try {
        ...
        if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            out.write("\n");
            out.write("            <a onclick=\"showArticle(");
            ...
            out.write(',');
            out.write('\'');
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.topic}", java.lang.String.class, (PageContext)_jspx_page_context, null));
            out.write("','");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.story}", java.lang.String.class, (PageContext)_jspx_page_context, null));
            out.write("')\">\n");
            out.write("                <div class=\"newsDetail\"  style=\"background-color: white\">\n");
            out.write("                    <span id=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
            out.write("\">\n");
            out.write("                        <h3><img src=\"");
            out.print(ct);
            out.write("/attachpath\" height=\"80\" width=\"80\" onclick=\"showAttch('");
            out.print(ct);
            out.write("/attchpath')\"/>\n");
            out.write("                            <b>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.topic}", java.lang.String.class, (PageContext)_jspx_page_context, null));
            ...
            out.write(" <b>วันที่ประกาศ:</b> ");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.senddate}", java.lang.String.class, (PageContext)_jspx_page_context, null));
            out.write(" \n");
            out.write("                        <b>หมวดหมู่:</b> \n");
            out.write("                        ");
            ...
            out.write("\n");
            out.write("                            <b>ระดับ:</b> ");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.priorityid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
            out.write("\n");
            out.write("                    </span>\n");
            out.write("                </div>\n");
            out.write("\n");
      ...
      out.write("\n");
      out.write("        <div class=\"newsDetail\">\n");
      out.write("            <a href=\"main.jsp?v=rm\"><h3>Read More</h3></a>\n");
      out.write("        </div>\n");
      out.write("    </ul>\n");
      out.write("</div>\n");
      out.write("   <div id=\"showAttch\" style=\"\">\n");
      out.write("            </div>\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      out.write("<!--         <a href=\"http://twitter.com/home?status=Custom%20status%20here\" target=\"_blank\">Post to Twitter!</a>-->\n");
    } catch (Throwable t) {
  ...
  private boolean _jspx_meth_c_when_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_0, PageContext _jspx_page_context)
    ...
    _jspx_th_c_when_0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${param.pri != null}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_sql_query_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_0, PageContext _jspx_page_context)
    ...
    try {
      ...
      if (_jspx_eval_sql_query_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("            SELECT * from news  where newstypeid=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${param.pri}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("  and status like 'active' order by priorityid desc;\n");
          out.write("        ");
  ...
  private boolean _jspx_meth_c_when_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_0, PageContext _jspx_page_context)
    ...
    _jspx_th_c_when_1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${param.pri == 0}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_sql_query_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_when_1, PageContext _jspx_page_context)
    ...
    try {
      ...
      if (_jspx_eval_sql_query_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("            SELECT * from news  where newstypeid = 5 and status like 'active'  order by priorityid desc;\n");
          out.write("        ");
  ...
  private boolean _jspx_meth_sql_query_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_otherwise_0, PageContext _jspx_page_context)
    ...
    try {
      ...
      if (_jspx_eval_sql_query_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("            SELECT * from news where  status like 'active'  order by priorityid desc;\n");
          out.write("        ");
  ...
  private boolean _jspx_meth_sql_query_3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_sql_query_3.setVar("result2");
    ...
    try {
      ...
      if (_jspx_eval_sql_query_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("                            SELECT * from newstype where id = ");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${item.newstypeid}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write(";\n");
          out.write("                        ");
