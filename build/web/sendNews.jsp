...
<link href="css/cssForSendNews.css" rel="stylesheet" type="text/css">
...
<script>
    ...
    <form name="addFeed" class="login active"action="addNewsServlet" method="GET">
        <table >
            <tr>
            ...
            <tr>
                ...
                <td><input type="date" name="fromdate" value="2012-01-17" size="50%" id="datepicker" placeholder="yyyy-mm-dd"  /></td>

            </tr>
            <tr>
                <td style="width:40%;">วันที่สิ้นสุดการประกาศ</td>
                <td><input type="date" name="todate" value="2012-01-20" size="50%" id="datepicker2" placeholder="yyyy-mm-dd"  /></td>
